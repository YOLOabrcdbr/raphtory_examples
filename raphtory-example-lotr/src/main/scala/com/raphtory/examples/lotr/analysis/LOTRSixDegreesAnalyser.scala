...
object LOTRSixDegreesAnalyser{
  def apply(seperation:Int): LOTRSixDegreesAnalyser = new LOTRSixDegreesAnalyser(Array(seperation.toString))
}

class LOTRSixDegreesAnalyser(args: Array[String]) extends Analyser[List[(Int,Int)]](args){
